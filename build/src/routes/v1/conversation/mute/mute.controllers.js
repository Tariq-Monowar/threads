...
exports.removeMute = exports.addMute = void 0;
const addMute = async (request, reply) => {
    try {
...
const removeMute = async (request, reply) => {
    try {
        const { myId, conversationIds } = request.body;
        const prisma = request.server.prisma;
        if (!myId || !conversationIds || !Array.isArray(conversationIds)) {
...
//# sourceMappingURL=mute.controllers.js.map