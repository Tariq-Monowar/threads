...
exports.getMyArchiveConversationsList = exports.removeArchived = exports.addArchived = void 0;
...
const addArchived = async (request, reply) => {
    try {
...
const removeArchived = async (request, reply) => {
    try {
        const { myId, conversationIds } = request.body;
        const prisma = request.server.prisma;
        if (!myId || !conversationIds || !Array.isArray(conversationIds)) {
...
exports.removeArchived = removeArchived;
const getMyArchiveConversationsList = async (request, reply) => {
    try {
...
exports.getMyArchiveConversationsList = getMyArchiveConversationsList;
//# sourceMappingURL=archive.controllers.js.map